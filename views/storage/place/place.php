                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="number" name="position" id="position" class="form-control" placeholder="Fach in der Reihe">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <button type="button" class="btn btn-outline-success" id="bookIn" data-place="<?= $place->getID() ?>">Einbuchen</button>
                        </div>
                    </div>
                </div>
            </div>
